package br.com.materres.validator;
...
public class CNPJValidator implements Validator {
    ...
    public void validate(FacesContext arg0, UIComponent arg1, Object valorTela) throws ValidatorException {
        if (!validaCNPJ(String.valueOf(valorTela))) {
            ...
            message.setSummary("Por favor digite um CPNJ válido!");
    ...
    public static boolean validaCNPJ(String cnpj) {
        ...
        System.out.println("CNPJ na entrada: " + cnpj);
        
        cnpj = cnpj.replaceAll("\\.", "");
        cnpj = cnpj.replaceAll("/", "");
        cnpj = cnpj.replaceAll("-", "");
        
        System.out.println("CNPJ depois da extraçao: " + cnpj);
